...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "98DTJ9NZ"; //Mã website tại VNPAY
    static $vnp_HashSecret = "MKLJJYZEZWCFFIKMCOLGOPFMVERNEIAH"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        $vnp_OrderType = 130000; // Loại hàng hóa: Máy tính - Thiết bị văn phòng (Xem thêm mã tại: https://sandbox.vnpayment.vn/apis/docs/loai-hang-hoa)
