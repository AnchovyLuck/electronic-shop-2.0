                ...
                <div class="col-lg-3">
                    ...
                    <div class="filter-widget">
                        ...
                        <div class="filter-range-wrap">
                            ...
                            <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget-content" data-min="33" data-max="90">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img zoomImg" src="{{URL('front/img/products/'.'/'.$product->productImages[0]->path)}}" alt="">
                            </div>
                                            ...
                                            @foreach ($product->productComments as $productComment)
                                                <div class="co-item">
                                                    <div class="avatar-pic">
                                                        <img src="{{URL('front/img/user/').'/'.($productComment->user->avatar ?? 'default-avatar.jpg')}}" alt="">
                                                    </div>
