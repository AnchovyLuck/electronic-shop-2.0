...
@section('body')
    ...
    <section class="product-shop spad">
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-6 col-lg-3 order-2 order-lg-1 produts-sidebar-filter">
                    <form action="shop">
                        ...
                        <div class="filter-widget">
                            ...
                            <div class="filter-range-wrap">
                                ...
                                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget-content" data-min="1000" data-max="100000"
