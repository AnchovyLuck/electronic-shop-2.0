                    ...
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tbody class="container">
                            @foreach ($productDetails as $productDetail)
                                <tr class="row">
                                    <td class="col-4 pl-4 text-muted">{{$product->name}}</td>

                                    <td class="col text-center">{{$productDetail->color}}</td>
                                    <td class="col text-center">{{$productDetail->RAM}}</td>
                                    <td class="col text-center">{{$productDetail->qty}}</td>
                                    ...
                                    <td class="text-center col">
                                        ...
                                        <form class="d-inline" action="admin/product/{{$product->id}}/detail/{{$productDetail->id}}" method="post">
                                            ...
                                            <button class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                                ...
                                                onclick="return confirm('Bạn muốn xóa chi tiết sản phẩm này sao?')">
                                                <span class="btn-icon-wrapper opacity-8">
